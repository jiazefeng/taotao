...
public class TestActiveMq {
	...
	public void testQueueProducer() throws Exception {
		...
		ConnectionFactory connectionFactory = new ActiveMQConnectionFactory("tcp://211.83.242.211.83.242.74");
	...
	public void testQueueConsumer() throws Exception {
		//创建一个连接工厂对象
		ConnectionFactory connectionFactory = new ActiveMQConnectionFactory("tcp://211.83.242.74:61616");
		//使用连接工厂对象创建一个连接
		Connection connection = connectionFactory.createConnection();
		connection.start();
		//使用连接对象创建一个Session对象
	...
	public void testTopicProducer() throws Exception {
		//创建一个连接工厂对象
		ConnectionFactory connectionFactory = new ActiveMQConnectionFactory("tcp://211.83.242.73:61616");
		//创建连接
		Connection connection = connectionFactory.createConnection();
		//开启连接
		connection.start();
